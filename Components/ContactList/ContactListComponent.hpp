...
#ifndef CONTACTLIST_CONTACTLISTCOMPONENT_HPP
#define CONTACTLIST_CONTACTLISTCOMPONENT_HPP
...
private:
	void OnStartup(StartupEvent&);
	void OnShutdown(ShutdownEvent&);
	
private:
	ContactListWindow	_window;
